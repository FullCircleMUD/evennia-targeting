...
- **Content documents** — one focused topic per file. Kebab-case filenames (`predicate-contract.md`, `walk-contents.md`).
...
- **Filename:** kebab-case, descriptive, stable (`predicate-contract.md`, not `notes-2026-05.md`).
...
- **Cross-references:** link to other design documents using relative paths (`[predicate contract](predicate-contract.md)`), and to root-level files with a leading slash (`[CLAUDE.md](../CLAUDE.md)`).
