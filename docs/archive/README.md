...
The folder is currently empty. If substrate material later emerges (e.g. design notes carried over from FCM's in-game `utils/targeting/` package the library is generalising, or brainstorming captured before a decision crystallised), drop it here and reference it from `../INDEX.md` under the `## Archive` section.
